...
<head>
  ...
  <link href="{{ asset('assets/mono/plugins/DataTables/DataTables-1.10.18/css/jquery.dataTables.min.css') }}" rel="stylesheet" />



  <link href="{{ asset('assets/mono/plugins/jvectormap/jquery-jvectormap-2.0.3.css') }}" rel="stylesheet" />



  <link href="{{ asset('assets/mono/plugins/daterangepicker/daterangepicker.css') }}" rel="stylesheet" />
  ...
  <link href="{{ asset('assets/mono/plugins/toaster/toastr.min.css') }}" rel="stylesheet" />
...
<body class="navbar-fixed sidebar-fixed" id="body">
  ...
  <div class="wrapper">
    ...
    <aside class="left-sidebar sidebar-light" id="left-sidebar">
      <div id="sidebar" class="sidebar sidebar-with-footer">
        ...
        <div class="app-brand">
          <a href="{{ route('admin') }}">
            <img src="{{ asset('assets/mono/images/logo.png') }}" alt="Mono">
            <span class="brand-name">SGPME</span>
          </a>
        </div>
          ...
          <ul class="nav sidebar-inner" id="sidebar-menu">
            ...
            <li class="has-sub">
              <a class="sidenav-item-link" href="javascript:void(0)" data-toggle="collapse" data-target="#sales" aria-expanded="false" aria-controls="sales">
                ...
                <span class="nav-text">{{ __('language.Sales') }}</span> <b class="caret"></b>
              </a>
              <ul class="collapse" id="sales" data-parent="#sidebar-menu">
                <div class="sub-menu">
            ...
            <li class="has-sub">
              ...
              <ul class="collapse" id="customization" data-parent="#sidebar-menu">
                <div class="sub-menu">
                  ...
                  <li>
                    <a class="sidenav-item-link" href="{{ route('definicao') }}">
                      <i class="mdi mdi-square-edit-outline"></i>
                  ...
                  <li>
                    <a class="sidenav-item-link" href="{{ route('definicao.email') }}">
                  ...
                  <li>
                    <a class="sidenav-item-link" href="{{ route('definicao.team') }}">
                      <span class="nav-text">Team</span>
          ...
          <div class="navbar-right ">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="custom-dropdown">
                ...
                <select class=" lang-change" name="changLang" id="lang-change" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" data-display="static">
              ...
              <li class="dropdown user-menu">
                <button class="dropdown-toggle nav-link" data-toggle="dropdown">
                  <img src="{{ asset('assets/mono/images/user/user-xs-01.jpg') }}" class="user-image rounded-circle" alt="User Image" />
                  <span class="d-none d-lg-inline-block">John Doe</span>
                </button>
                <ul class="dropdown-menu dropdown-menu-right">
                  <li>
                    <a class="dropdown-link-item" href="{{ route('user.perfil') }}">
                  ...
                  <li>
                    <a class="dropdown-link-item" href="{{ route('admin') }}">
  ...
  <script src="{{ asset('assets/mono/plugins/jquery/jquery.min.js') }}"></script>
  <script src="{{ asset('assets/mono/plugins/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
  <script src="{{ asset('assets/mono/plugins/simplebar/simplebar.min.js') }}"></script>
  <script src="https://unpkg.com/hotkeys-js/dist/hotkeys.min.js"></script>

  <script src="{{ asset('assets/mono/plugins/apexcharts/apexcharts.js') }}"></script>

  <script src="{{ asset('assets/mono/plugins/DataTables/DataTables-1.10.18/js/jquery.dataTables.min.js') }}"></script>

  <script src="{{ asset('assets/mono/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js') }}"></script>
  <script src="{{ asset('assets/mono/plugins/jvectormap/jquery-jvectormap-world-mill.js') }}"></script>
  <script src="{{ asset('assets/mono/plugins/jvectormap/jquery-jvectormap-us-aea.js') }}"></script>

  <script src="{{ asset('assets/mono/plugins/daterangepicker/moment.min.js') }}"></script>
  <script src="{{ asset('assets/mono/plugins/daterangepicker/daterangepicker.js') }}"></script>
  <script>
  ...
  <script src="{{ asset('assets/mono/plugins/toaster/toastr.min.js') }}"></script>
  <script src="{{ asset('assets/mono/plugins/circle-progress/circle-progress.js') }}"></script>

  <script src="{{ asset('assets/mono/js/mono.js') }}"></script>
  <script src="{{ asset('assets/mono/js/chart.js') }}"></script>
  <script src="{{ asset('assets/mono/js/map.js') }}"></script>
  <script src="{{ asset('assets/mono/js/custom.js') }}"></script>
